...
class Temporal_EncDec_G6(nn.Module):
    def __init__(self, bottle_neck_size):
        ...
        self.fc1 = torch.nn.Linear(in_features=3872,out_features=968)
...
class ST_AutoEncoder_G7(nn.Module):
    ...
    def __init__(self, in_channel, bottle_neck_size, drop_rate):
        ...
        self.in_channel = in_channel
        self.name = "G7"
        self.description = "G1 with hidden dim 32"
        self.bottle_neck_size = bottle_neck_size
...
class ST_AutoEncoder_G8(nn.Module):
    
    def __init__(self, in_channel, bottle_neck_size):
        super(ST_AutoEncoder_G8, self).__init__()
        
        self.in_channel = in_channel
        self.name = "G8"
        self.description = "G2 but with different functions, tanh after second linear layer"
        self.bottle_neck_size = bottle_neck_size
        ...
        # Temporal Encoder & Decoder
        self.temporal_encoder_decoder = Temporal_EncDec_G8(bottle_neck_size)
...
class Temporal_EncDec_G8(nn.Module):
    def __init__(self, bottle_neck_size):
        super(Temporal_EncDec_G8, self).__init__()
...
class ST_AutoEncoder_G9(nn.Module):
    
    def __init__(self, in_channel, bottle_neck_size):
        super(ST_AutoEncoder_G9, self).__init__()
        
        self.in_channel = in_channel
        self.name = "G9"
        self.description = "smaller hidden dim than G8"
        self.bottle_neck_size = bottle_neck_size
        ...
        # Temporal Encoder & Decoder
        self.temporal_encoder_decoder = Temporal_EncDec_G9(bottle_neck_size)
...
class Temporal_EncDec_G9(nn.Module):
    def __init__(self, bottle_neck_size):
        super(Temporal_EncDec_G9, self).__init__()
        ...
        self.fc1 = torch.nn.Linear(in_features=968,out_features=bottle_neck_size)
        
        self.fc2 =  torch.nn.Linear(in_features=bottle_neck_size, out_features=968)
